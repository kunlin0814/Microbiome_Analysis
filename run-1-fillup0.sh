...
do
	...
	rm $line.sam-readsID-PhylumFamilySpecies-SpeciesSum-sort
	rm $line.sam-readsID-PhylumFamilySpecies-PhylumSum-sort 
	rm $line.sam-readsID-PhylumFamilySpecies-FamilySum-sort
	...
	rm $line.sam-readsID-PhylumFamilySpecies-SpeciesSum-sort-fill0
	rm $line.sam-readsID-PhylumFamilySpecies-PhylumSum-sort-fill0
	rm $line.sam-readsID-PhylumFamilySpecies-FamilySum-sort-fill0

...
species_value=int(score[candidate_phylum])
...
output=open(candidate_phylum + '_Phylum_value.txt' ,'w')
#output.write('file_name'+'\t'+ candidate_phylum +'\n')

...
while read line;
do 
    cd /scratch/kh31516/Gtex/Blood/WGS_normal_blood_result/results/gt_cutoff/$line
...
do 
    cd /scratch/kh31516/Gtex/Blood/WGS_normal_blood_result/results/gt_cutoff/$line
    python3.7 /scratch/kh31516/Gtex/Blood/WGS_normal_blood_result/results/gt_cutoff/micro_phylum_enrich.py HumanMicroBiome/${line}.sam-readsID-PhylumFamilySpecies-PhylumSum-sort-fill0 ${line}-TotalReads
    python3.7 /scratch/kh31516/Gtex/Blood/WGS_normal_blood_result/results/gt_cutoff/micro_family_enrich.py HumanMicroBiome/${line}.sam-readsID-PhylumFamilySpecies-FamilySum-sort-fill0 ${line}-TotalReads
    python3.7 /scratch/kh31516/Gtex/Blood/WGS_normal_blood_result/results/gt_cutoff/micro_species_enrich.py HumanMicroBiome/${line}.sam-readsID-PhylumFamilySpecies-SpeciesSum-sort-fill0 ${line}-TotalReads

done < /scratch/kh31516/Gtex/Blood/WGS_normal_blood_result/results/gt_cutoff/source/total_colon_blood_cases.txt
"
: "
while read line;
do 
    cd /scratch/kh31516/Gtex/Blood/WGS_normal_blood_result/results/gt_cutoff/$line
    cat fuso_enrich_phylum.txt >> cd /scratch/kh31516/Gtex/Blood/WGS_normal_blood_result/results/gt_cutoff/fuso_phylum_sum.txt
    cat fuso_enrich_family.txt >> cd /scratch/kh31516/Gtex/Blood/WGS_normal_blood_result/results/gt_cutoff/fuso_family_sum.txt
    cat fuso_enrich_species.txt >> cd /scratch/kh31516/Gtex/Blood/WGS_normal_blood_result/results/gt_cutoff/fuso_species_sum.txt
done < /scratch/kh31516/Gtex/Blood/WGS_normal_blood_result/results/gt_cutoff/source/total_colon_blood_cases.txt
"

...
do
	...
	#mv SRR*.sam-readsID-PhylumFamilySpecies-SpeciesSum ${line}.sam-readsID-PhylumFamilySpecies-SpeciesSum
	#mv SRR*.sam-readsID-PhylumFamilySpecies-PhylumSum ${line}.sam-readsID-PhylumFamilySpecies-PhylumSum
	#mv SRR*.sam-readsID-PhylumFamilySpecies-FamilySum ${line}.sam-readsID-PhylumFamilySpecies-FamilySum
